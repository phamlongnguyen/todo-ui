...
function TaskPannel() {
  return (
    <div className="mt-6 bg-white border border-solid border-gray-300 rounded flex-1 min-h-[500px] overflow-auto flex flex-col">
      ...
      <div className=" min-w-[500px] flex-1 w-full">
        <DropPanel />
      </div>
    </div>
  );
